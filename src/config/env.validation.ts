...
export const envValidationSchema = Joi.object({
  ...
  MAX_UPLOAD_SIZE_BYTES: Joi.number().default(6291456),
  THROTTLE_TTL_SECONDS: Joi.number().default(60),
  THROTTLE_LIMIT: Joi.number().default(60),
  LOGIN_THROTTLE_TTL_SECONDS: Joi.number().default(60),
  LOGIN_THROTTLE_LIMIT: Joi.number().default(5),
  CONTACT_THROTTLE_TTL_SECONDS: Joi.number().default(600),
  CONTACT_THROTTLE_LIMIT: Joi.number().default(1),
  CONTACT_EMAIL_COOLDOWN_HOURS: Joi.number().default(24),
